...
**[LCV-VC-Live]**
From time to time, a new instance of verifier is called with a height _h_. Each instance must eventually terminate. The instance adds a header _hd_ with height _h_ to _State_ if
