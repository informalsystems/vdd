...
block is OK, e.g., signed by validators that represent more than 2/3 of the voting power.
 ...
 This document refers to
   ...
   - some specification of the blockchain "Tendermint consensus" with full nodes, validators, tendermint failure model, trusting trustingPeriod  **add link or make up a file**

   - some specification what constitutes are valid block. what can be checked without writing code that does the checks.
