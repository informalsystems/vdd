...
The challenge addressed here is that the light client might have a block of
...
**TODO:** link to validity condition and checks in the blockchain spec.
...
messages are not lost, not duplicated, and eventually delivered.
...
contains headers.  
**TODO:** make consistent with failure detector
...
**TODO:** *State* is missing. Should be made consistent with failure
detector. We should decide what it contains: e.g., (i) set of headers,
...
**TODO:** link to blockhain validation and check.
...
from the *primary*, by calling `QueryFullNode`.
